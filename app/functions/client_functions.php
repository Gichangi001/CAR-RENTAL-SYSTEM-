...
/* Car Rentals */
$query = "SELECT COUNT(*) FROM car_rentals WHERE rental_client_id = '{$client_id}'";
...
/* Revenue */
$query = "SELECT SUM(payment_amount) FROM payments p INNER JOIN car_rentals cr ON cr.rental_id = p.payment_rental_id
