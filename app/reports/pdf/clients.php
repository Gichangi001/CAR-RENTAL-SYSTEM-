            ...
            <html>
                ...
                <body style="margin:1px;">
                    <div class="list_header" align="center">
                        ...
                        <h5>Clients Reports - Generated On '.date('d M Y').'</h5>
                    </div>
                                ...
                                while ($clients = mysqli_fetch_array($clients_sql)) {
                                    $html .=
                                        '
                                            <tr>
                                                <td>' . $cnt . '</td>
                                                <td>' . $clients['client_names'] . '</td>
                                                <td>' . $clients['client_id_no'] . '</td>
                                                <td>' . $clients['client_phone_number'] . '</td>
                                                <td>' . $clients['client_email'] . '</td>
                                                <td>' . $clients['client_date_joined'] . '</td>
...
$dompdf->render();
$dompdf->stream('Client Reports Generated On'. date('d M Y'), array("Attachment" => 1));
