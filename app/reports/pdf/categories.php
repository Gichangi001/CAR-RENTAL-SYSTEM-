            ...
            <html>
                ...
                <body style="margin:1px;">
                    <div class="list_header" align="center">
                        ...
                        <h5>Vehicle Categories List - Generated On ' . date('d M Y') . '</h5>
                    </div>
                    <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
                        <thead>
                            <tr>
                                <th style="width:20%">S/N</th>
                                <th style="width:100%">Category Code</th>
...
$dompdf->render();
$dompdf->stream('Vehicle Categories List Generated On' . date('d M Y'), array("Attachment" => 1));
