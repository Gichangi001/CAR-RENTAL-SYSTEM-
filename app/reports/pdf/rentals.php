            ...
            <html>
                ...
                <body style="margin:1px;">
                    <div class="list_header" align="center">
                        ...
                        <h5>Rental List - Generated On ' . date('d M Y') . '</h5>
                    </div>
                    <table border="1" cellspacing="0" width="100%" style="font-size:9pt">
                        <thead>
                            <tr>
                                ...
                                <th style="width:100%">Client Names</th>
                                <th style="width:100%">Client Contacts</th>
                                <th style="width:100%">Rented On</th>
                                <th style="width:100%">Returned On</th>
                                <th style="width:100%">Rental Amount</th>
