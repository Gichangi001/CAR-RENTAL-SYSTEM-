                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="tel://"><span class="icon icon-phone"></span><span class="text">+2 392 3929 210</span></a></li>
                            <li><a href="mailto://"><span class="icon icon-envelope"></span><span class="text">info@yourdomain.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <p>
                    ...
                    </script> All rights reserved | Crafted with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://devlan.co.ke" target="_blank">Devlan Solutions LTD</a>
                </p>
            </div>
        </div>
    </div>
