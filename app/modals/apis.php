<!-- Update Modal -->
<div class="modal fade fixed-right" id="update_<?php echo $apis['api_id']; ?>" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header align-items-center">
                <div class="text-center">
                    <h6 class="mb-0 text-bold">Update <?php echo $apis['api_name']; ?></h6>
                </div>
                ...
                <form class="needs-validation" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="hidden" value="<?php echo $apis['api_id']; ?>" required name="api_id" class="form-control">
                            <input type="text" value="<?php echo $apis['api_name']; ?>" required name="api_name" class="form-control">
                        </div>
                        <div class="form-group col-md-12">
